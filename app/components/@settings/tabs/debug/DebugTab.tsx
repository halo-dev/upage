    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="i-ph:package text-upage-elements-textSecondary size-4" />
          <span className="text-base text-upage-elements-textPrimary">
            {title} Dependencies ({deps.length})
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-sm text-upage-elements-textSecondary">{isOpen ? 'Hide' : 'Show'}</span>
          <div
            className={classNames(
          ...
          <div className="space-y-2 p-4">
            {deps.map((dep) => (
              <div key={dep.name} className="flex items-center justify-between text-sm">
                <span className="text-upage-elements-textPrimary">{dep.name}</span>
                <span className="text-upage-elements-textSecondary">{dep.version}</span>
              </div>
            ))}
          </div>
        </ScrollArea>
...
export default function DebugTab() {
  ...
  const exportAsCSV = () => {
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = `upage-debug-info-${new Date().toISOString()}.csv`;
      document.body.appendChild(a);
      a.click();
      window.URL.revokeObjectURL(url);
      document.body.removeChild(a);
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Save the PDF
      doc.save(`upage-debug-info-${new Date().toISOString()}.pdf`);
  ...
  const exportAsText = () => {
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = `upage-debug-info-${new Date().toISOString()}.txt`;
      document.body.appendChild(a);
      a.click();
      window.URL.revokeObjectURL(url);
      document.body.removeChild(a);
        ...
        <Dialog showCloseButton>
          <div className="p-6">
            <DialogTitle className="flex items-center gap-2">
              <div className="i-ph:download size-5" />
            ...
            <div className="mt-4 flex flex-col gap-2">
              {exportFormats.map((format) => (
                ...
                >
                  <div className={classNames(format.icon, 'size-5')} />
                  <div>
                    <div className="font-medium">{format.label}</div>
                    <div className="text-xs text-upage-elements-textSecondary mt-0.5">
    ...
    <div className="flex flex-col gap-6 max-w-7xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:warning-octagon text-purple-500 size-4" />
            <div className="text-sm text-upage-elements-textSecondary">Errors</div>
          </div>
          ...
          <div className="text-xs text-upage-elements-textSecondary mt-2 flex items-center gap-1.5">
            <div
              className={classNames(
                'w-3.5 h-3.5',
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:cpu text-purple-500 size-4" />
            <div className="text-sm text-upage-elements-textSecondary">Memory Usage</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:timer text-purple-500 size-4" />
            <div className="text-sm text-upage-elements-textSecondary">Page Load Time</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
          ...
          <div className="text-xs text-upage-elements-textSecondary mt-2 flex items-center gap-1.5">
            <div className="i-mingcute:code-line w-3.5 h-3.5 text-purple-500" />
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:wifi-high text-purple-500 size-4" />
            <div className="text-sm text-upage-elements-textSecondary">Network Speed</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
      ...
      <div className="flex flex-wrap gap-4">
        ...
        >
          {loading.systemInfo ? (
            ...
            <div className="i-ph:gear size-4" />
          )}
          Update System Info
        </button>
        ...
        >
          {loading.errors ? (
            ...
            <div className="i-ph:warning size-4" />
          )}
          Check Errors
        </button>
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              <div className="i-ph:cpu text-purple-500 size-5" />
              <h3 className="text-base font-medium text-upage-elements-textPrimary">System Information</h3>
            </div>
            <div
              className={classNames(
                'i-ph:caret-down size-4 transform transition-transform duration-200',
        ...
        <CollapsibleContent>
          <div className="p-6 mt-2 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            {systemInfo ? (
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:desktop text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">OS: </span>
                    <span className="text-upage-elements-textPrimary">{systemInfo.os}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:device-mobile text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Platform: </span>
                    <span className="text-upage-elements-textPrimary">{systemInfo.platform}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:microchip text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Architecture: </span>
                    <span className="text-upage-elements-textPrimary">{systemInfo.arch}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:cpu text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">CPU Cores: </span>
                    <span className="text-upage-elements-textPrimary">{systemInfo.cpus}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:node text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Node Version: </span>
                    <span className="text-upage-elements-textPrimary">{systemInfo.node}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:wifi-high text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Network Type: </span>
                    <span className="text-upage-elements-textPrimary">
                      {systemInfo.network.type} ({systemInfo.network.effectiveType})
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:gauge text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Network Speed: </span>
                    <span className="text-upage-elements-textPrimary">
                  ...
                  {systemInfo.battery && (
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:battery-charging text-upage-elements-textSecondary size-4" />
                      <span className="text-upage-elements-textSecondary">Battery: </span>
                      <span className="text-upage-elements-textPrimary">
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:hard-drive text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Storage: </span>
                    <span className="text-upage-elements-textPrimary">
                ...
                <div className="space-y-2">
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:database text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Memory Usage: </span>
                    <span className="text-upage-elements-textPrimary">
                      {systemInfo.memory.used} / {systemInfo.memory.total} ({systemInfo.memory.percentage}%)
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:browser text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Browser: </span>
                    <span className="text-upage-elements-textPrimary">
                      {systemInfo.browser.name} {systemInfo.browser.version}
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:monitor text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Screen: </span>
                    <span className="text-upage-elements-textPrimary">
                      {systemInfo.screen.width}x{systemInfo.screen.height} ({systemInfo.screen.pixelRatio}x)
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:clock text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Timezone: </span>
                    <span className="text-upage-elements-textPrimary">{systemInfo.time.timezone}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:translate text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Language: </span>
                    <span className="text-upage-elements-textPrimary">{systemInfo.browser.language}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:chart-pie text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">JS Heap: </span>
                    <span className="text-upage-elements-textPrimary">
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:timer text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">Page Load: </span>
                    <span className="text-upage-elements-textPrimary">
                      {(systemInfo.performance.timing.loadTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-mingcute:code-line text-upage-elements-textSecondary size-4" />
                    <span className="text-upage-elements-textSecondary">DOM Ready: </span>
                    <span className="text-upage-elements-textPrimary">
              ...
              <div className="text-sm text-upage-elements-textSecondary">Loading system information...</div>
            )}
          </div>
        </CollapsibleContent>
      </Collapsible>
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              <div className="i-ph:chart-line text-purple-500 size-5" />
              <h3 className="text-base font-medium text-upage-elements-textPrimary">Performance Metrics</h3>
            </div>
            <div
              className={classNames(
                'i-ph:caret-down size-4 transform transition-transform duration-200',
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <div className="text-sm">
                    <span className="text-upage-elements-textSecondary">Page Load Time: </span>
                    <span className="text-upage-elements-textPrimary">
                      {(systemInfo.performance.timing.loadTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-upage-elements-textSecondary">DOM Ready Time: </span>
                    <span className="text-upage-elements-textPrimary">
                      {(systemInfo.performance.timing.domReadyTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-upage-elements-textSecondary">Request Time: </span>
                    <span className="text-upage-elements-textPrimary">
                      {(systemInfo.performance.timing.requestTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-upage-elements-textSecondary">Redirect Time: </span>
                    <span className="text-upage-elements-textPrimary">
                ...
                <div className="space-y-2">
                  <div className="text-sm">
                    <span className="text-upage-elements-textSecondary">JS Heap Usage: </span>
                    <span className="text-upage-elements-textPrimary">
                      {(systemInfo.performance.memory.usedJSHeapSize / (1024 * 1024)).toFixed(1)}MB /{' '}
                      {(systemInfo.performance.memory.totalJSHeapSize / (1024 * 1024)).toFixed(1)}MB
                    </span>
                  ...
                  <div className="text-sm">
                    <span className="text-upage-elements-textSecondary">Heap Utilization: </span>
                    <span className="text-upage-elements-textPrimary">
                      {systemInfo.performance.memory.usagePercentage.toFixed(1)}%
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-upage-elements-textSecondary">Navigation Type: </span>
                    <span className="text-upage-elements-textPrimary">
                  ...
                  <div className="text-sm">
                    <span className="text-upage-elements-textSecondary">Redirects: </span>
                    <span className="text-upage-elements-textPrimary">
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              <div className="i-ph:info text-blue-500 size-5" />
              <h3 className="text-base font-medium text-upage-elements-textPrimary">WebApp Information</h3>
        ...
        <CollapsibleContent>
          <div className="p-6 mt-2 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            {loading.webAppInfo ? (
              ...
              <div className="flex flex-col items-center justify-center p-8 text-upage-elements-textSecondary">
                <div className="i-ph:warning-circle size-8 mb-2" />
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <h3 className="mb-4 text-base font-medium text-upage-elements-textPrimary">Basic Information</h3>
                  <div className="space-y-3">
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:app-window text-upage-elements-textSecondary size-4" />
                      <span className="text-upage-elements-textSecondary">Name:</span>
                      <span className="text-upage-elements-textPrimary">{webAppInfo.name}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:tag text-upage-elements-textSecondary size-4" />
                      <span className="text-upage-elements-textSecondary">Version:</span>
                      <span className="text-upage-elements-textPrimary">{webAppInfo.version}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:certificate text-upage-elements-textSecondary size-4" />
                      <span className="text-upage-elements-textSecondary">License:</span>
                      <span className="text-upage-elements-textPrimary">{webAppInfo.license}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:cloud text-upage-elements-textSecondary size-4" />
                      <span className="text-upage-elements-textSecondary">Environment:</span>
                      <span className="text-upage-elements-textPrimary">{webAppInfo.environment}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:node text-upage-elements-textSecondary size-4" />
                      <span className="text-upage-elements-textSecondary">Node Version:</span>
                      <span className="text-upage-elements-textPrimary">{webAppInfo.runtimeInfo.nodeVersion}</span>
                    </div>
                  </div>
                </div>

                <div>
                  <h3 className="mb-4 text-base font-medium text-upage-elements-textPrimary">Git Information</h3>
                  <div className="space-y-3">
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:git-branch text-upage-elements-textSecondary size-4" />
                      <span className="text-upage-elements-textSecondary">Branch:</span>
                      <span className="text-upage-elements-textPrimary">{webAppInfo.gitInfo.local.branch}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:git-commit text-upage-elements-textSecondary size-4" />
                      <span className="text-upage-elements-textSecondary">Commit:</span>
                      <span className="text-upage-elements-textPrimary">{webAppInfo.gitInfo.local.commitHash}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:user text-upage-elements-textSecondary size-4" />
                      <span className="text-upage-elements-textSecondary">Author:</span>
                      <span className="text-upage-elements-textPrimary">{webAppInfo.gitInfo.local.author}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:clock text-upage-elements-textSecondary size-4" />
                      <span className="text-upage-elements-textSecondary">Commit Time:</span>
                      <span className="text-upage-elements-textPrimary">{webAppInfo.gitInfo.local.commitTime}</span>
                    </div>
                    ...
                    {webAppInfo.gitInfo.github && (
                      <>
                        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
                          <div className="text-sm flex items-center gap-2">
                            <div className="i-mingcute:github-line text-upage-elements-textSecondary size-4" />
                            <span className="text-upage-elements-textSecondary">Repository:</span>
                            <span className="text-upage-elements-textPrimary">
                          ...
                          <div className="mt-2 flex items-center gap-4 text-sm">
                            <div className="flex items-center gap-1">
                              <div className="i-ph:star text-yellow-500 size-4" />
                              <span className="text-upage-elements-textSecondary">
                                {webAppInfo.gitInfo.github.currentRepo.stars}
                              </span>
                            </div>
                            <div className="flex items-center gap-1">
                              <div className="i-ph:git-fork text-blue-500 size-4" />
                              <span className="text-upage-elements-textSecondary">
                                {webAppInfo.gitInfo.github.currentRepo.forks}
                              </span>
                            </div>
                            <div className="flex items-center gap-1">
                              <div className="i-ph:warning-circle text-red-500 size-4" />
                              <span className="text-upage-elements-textSecondary">
                        ...
                        {webAppInfo.gitInfo.github.upstream && (
                          <div className="mt-2">
                            <div className="text-sm flex items-center gap-2">
                              <div className="i-ph:git-fork text-upage-elements-textSecondary size-4" />
                              <span className="text-upage-elements-textSecondary">Upstream:</span>
                              <span className="text-upage-elements-textPrimary">
            ...
            {webAppInfo && (
              <div className="mt-6">
                <h3 className="mb-4 text-base font-medium text-upage-elements-textPrimary">Dependencies</h3>
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              <div className="i-ph:warning text-red-500 size-5" />
              <h3 className="text-base font-medium text-upage-elements-textPrimary">Error Check</h3>
              {errorLogs.length > 0 && (
          ...
          <div className="p-6 mt-2 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <ScrollArea className="h-[300px]">
              <div className="space-y-4">
                ...
                <div className="text-sm">
                  <span className="text-upage-elements-textSecondary">Status: </span>
                  <span className="text-upage-elements-textPrimary">
                    {loading.errors
                      ? 'Checking...'
                      : errorLogs.length > 0
                ...
                {errorLogs.length > 0 && (
                  <div className="mt-4">
                    <div className="text-sm font-medium text-upage-elements-textPrimary mb-2">Recent Errors:</div>
                    <div className="space-y-2">
                      {errorLogs.map((error) => (
